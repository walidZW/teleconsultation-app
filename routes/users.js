...
//   })(req, res, next);
// });
//POST  ==> post method of login route 
    ...
    req.logIn(user, function (err) {
      ...
      User.findOne({
        ...
        if (user.role == 'patient')
          return res.redirect('../patient/' + user.userName)
        if (user.role == 'admin')
          return res.redirect('../admin/' + user.userName)
        if (user.role == 'doctor') {
          if (user.status == 'Registered')
            return res.redirect('../doctor/' + user.userName)
          else {
...
//POST ==> post method of register route
...
//POST ==> post method of doctor register route
